...
class Loader extends StatelessWidget {
  ...
  const Loader({super.key, this.color = AppColors.primary, this.scale});

  @override
  Widget build(BuildContext context) {
    return Center(
      child: Transform.scale(scale: scale ?? 0.5.sp, child: CircularProgressIndicator(color: color, strokeWidth: 5)),
    );
  }
}
